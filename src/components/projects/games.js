...
class Games extends Component {
    render(){
        return(
                ...
                description="Adora's Adventure is a P5.js based project created after following Alura's GameDev week (#imersaoGameDev). It was based on 
                She-Ra and The Princesses of Power cartoon and it was my first contact with game development using JS. The game assets and the game code were created by me."
